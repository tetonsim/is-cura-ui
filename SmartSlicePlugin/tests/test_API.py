...
class TestAPI(_SmartSliceTestCase):
    ...
    def test_login_connection_failure(self):
        ...
        self.assertEqual(self._api._error_message.getText(), """Unable to contact Smart Slice servers!<br><br>Please check to ensure you have an internet connection. If you<br>do have an internet connection, and are still receiving this<br>error, please <A HREF='mailto:help@tetonsim.com?subject=Smart Slice Cannot Connect Error'>contact us</A>.""")
